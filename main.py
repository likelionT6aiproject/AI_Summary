...
model = AutoModelForSeq2SeqLM.from_pretrained('F:\python\4th\t5-base-korean-summarization')
tokenizer = AutoTokenizer.from_pretrained('F:\python\4th\t5-base-korean-summarization')
